...
export const eligibilityInquiryOperations: INodeProperties[] = [
  {
    ...
    options: [
      {
        name: 'Verify',
        value: 'verify',
        description: 'Get complete 271 response with all benefit details',
        action: 'Verify full eligibility inquiry',
      },
    ],
    default: 'verify',
  },
...
export const eligibilityInquiryFields: INodeProperties[] = [
  // Payer Information
  {
    ...
    default: '',
    placeholder: '00001',
    description: 'pVerify Payer ID. Use the Payer List operation to find valid codes.',
    displayOptions: {
      show: {
        resource: ['eligibilityInquiry'],
        operation: ['verify'],
  ...
  },
  {
    ...
    required: true,
    default: '',
    description: 'End date of service for eligibility check',
    displayOptions: {
      show: {
        resource: ['eligibilityInquiry'],
        operation: ['verify'],
  ...
  // Additional Options
  {
    ...
    options: [
      ...
      {
        displayName: 'Include Plan Network Info',
        name: 'includePlanNetworkInfo',
        type: 'boolean',
        default: false,
        description: 'Whether to include detailed plan network information',
      },
    ],
  },
];
